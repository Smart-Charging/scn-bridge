...
describe("SCPI Locations Controller", () => {
    ...
    context("Sender interface", () => {
        ...
        it("should return single location", (done) => {
            ...
            request(app)
            .get("/scpi/sender/2.2/locations/LOC1")
            .set("Authorization", "Token token-b")
            .set("X-Request-ID", "123")
            .set("X-Correlation-ID", "456")
            .set("SCPI-From-Country-Code", "DE")
        ...
        it("should return single evse", (done) => {
            ...
            request(app)
            .get("/scpi/sender/2.2/locations/LOC1/1234")
            .set("Authorization", "Token token-b")
            .set("X-Request-ID", "123")
            .set("X-Correlation-ID", "456")
            .set("SCPI-From-Country-Code", "DE")
        ...
        it("should return single connector", (done) => {
            ...
            request(app)
            .get("/scpi/sender/2.2/locations/LOC1/1234/1")
            .set("Authorization", "Token token-b")
            .set("X-Request-ID", "123")
            .set("X-Correlation-ID", "456")
            .set("SCPI-From-Country-Code", "DE")
