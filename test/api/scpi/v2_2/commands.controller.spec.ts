...
describe("SCPI Commands Controller", () => {
    ...
    beforeEach(async () => {
        ...
        scnNode = await startNode(3001, events)
    })
    ...
    context("Sender interface", () => {
        ...
        it("should return 1000", (done) => {
            ...
            request(app)
                .post("/scpi/sender/2.2/commands/START_SESSION/1234")
    ...
    context("Receiver interface", () => {
        ...
        it("should return CommandResponse and send async CommandResult on START_SESSION", (done) => {
            ...
            request(app)
                .post("/scpi/receiver/2.2/commands/START_SESSION")
                .set("Authorization", "Token token-b")
                .set("X-Request-ID", "123")
                .set("X-Correlation-ID", "456")
                .set("SCPI-From-Country-Code", "DE")
                ...
                .end((err, result) => {
                    ...
                    events.once("START_SESSION", (req: Request) => {
                        ...
                        assert.equal(req.headers["scpi-from-country-code"], "DE")
                        assert.equal(req.headers["scpi-from-party-id"], "CPO")
                        assert.equal(req.headers["scpi-to-country-code"], "DE")
                        assert.equal(req.headers["scpi-to-party-id"], "MSP")
        ...
        it("should return CommandResponse and send async CommandResult on STOP_SESSION", (done) => {
            ...
            request(app)
                .post("/scpi/receiver/2.2/commands/STOP_SESSION")
                .set("Authorization", "Token token-b")
                .set("X-Request-ID", "123")
                .set("X-Correlation-ID", "456")
                .set("SCPI-From-Country-Code", "DE")
        ...
        it("should return NOT_SUPPORTED on CANCEL_RESERVATION", (done) => {
            ...
            request(app)
                .post("/scpi/receiver/2.2/commands/CANCEL_RESERVATION")
                .set("Authorization", "Token token-b")
                .send({
        ...
        it("should return NOT_SUPPORTED on RESERVE_NOW", (done) => {
            ...
            request(app)
                .post("/scpi/receiver/2.2/commands/RESERVE_NOW")
                .set("Authorization", "Token token-b")
                .send({
        ...
        it("should return NOT_SUPPORTED on UNLOCK_CONNECTOR", (done) => {
            ...
            request(app)
                .post("/scpi/receiver/2.2/commands/UNLOCK_CONNECTOR")
                .set("Authorization", "Token token-b")
                .send({
